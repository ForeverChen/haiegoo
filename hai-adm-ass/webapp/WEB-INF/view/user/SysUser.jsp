...
Ext.onReady(function() {
		       	    ...
		       	    items:[Ext.create('Ext.tree.Panel', {
		    			...
		    			viewConfig : {
		    				onCheckboxChange : function(e, t) {
		    				    ...
		    				    if (item) {
		    				    	//标记为修改
		    				    	Ext.getCmp("treeAdminModule").modified = true;
		    						...
		    						//勾选角色模块权限
		    						var roleModuleIds = Ext.getCmp("gridAdmin").selModel.getSelection()[0].get("roleModuleIds");
        ...
        tbar: [{
		    ...
		    handler: function(btn, event) {
		    	...
		    	winAdmin.show(this,function(){
		    		...
		    		treeAdminModule.modified = false;
	...
	function saveAdmin(win, frm, grid){
		...
		//勾选的模块
		ajaxparams += "&moduleModified="+ treeAdminModule.modified +"&moduleIds=";
		checkedNodes = treeAdminModule.getChecked();
		for ( var i = 0; i < checkedNodes.length; i++) {
