...
/**
 * A variation on the Lucene QueryParser which knows about the field types and
 * query time analyzers configured in Solr's schema.xml.
 * 
 * <p>
 * This class also deviates from the Lucene QueryParser by using ConstantScore
 * versions of RangeQuery and PrefixQuery to prevent TooManyClauses exceptions.
 * </p>
 * 
 * <p>
 * If the magic field name "<code>_val_</code>" is used in a term or phrase
 * query, the value is parsed as a function.
 * </p>
 * 
 * @see org.apache.solr.search.QueryParsing#parseFunction
 */
public class KSolrQueryParser extends QueryParser {
	...
	/**
	 * Constructs a SolrQueryParser using the schema to understand the formats
	 * and datatypes of each field. Only the defaultSearchField will be used
	 * from the IndexSchema (unless overridden), &lt;solrQueryParser&gt; will
	 * not be used.
	 * 
	 * @param schema
	 *            Used for default search field name if defaultField is null and
	 *            field information is used for analysis
	 * @param defaultField
	 *            default field used for unspecified search terms. if null, the
	 *            schema default field is used
	 * @see org.apache.solr.schema.IndexSchema#getDefaultSearchFieldName()
	 */
	@SuppressWarnings("deprecation")
	public KSolrQueryParser(IndexSchema schema, String defaultField) {
		super(schema.getSolrConfig().luceneMatchVersion,
				defaultField == null ? schema.getDefaultSearchFieldName()
	...
	public KSolrQueryParser(QParser parser, String defaultField) {
		this(parser, defaultField, parser.getReq().getSchema()
				.getQueryAnalyzer());
	}
	...
	public KSolrQueryParser(QParser parser, String defaultField,
			Analyzer analyzer) {
		super(parser.getReq().getSchema().getSolrConfig().luceneMatchVersion,
	...
	protected ReversedWildcardFilterFactory getReversedWildcardFilterFactory(
		...
		if (leadingWildcards == null)
			leadingWildcards = new HashMap<FieldType, ReversedWildcardFilterFactory>();
		...
		if (a instanceof TokenizerChain) {
			// examine the indexing analysis chain if it supports leading
			// wildcards
	...
	protected Query getFieldQuery(String field, String queryText, boolean quoted)
		...
		if (sf != null) {
			...
			if (ft instanceof TextField) {
				...
				return super.getFieldQuery(field, queryText, false);
			} else {
	...
	protected Query getRangeQuery(String field, String part1, String part2,
		...
		return sf.getType().getRangeQuery(parser, sf, part1, part2, inclusive,
				inclusive);
	}
	...
	protected Query getWildcardQuery(String field, String termStr)
		...
		// Solr has always used constant scoring for wildcard queries. This
		// should return constant scoring by default.
